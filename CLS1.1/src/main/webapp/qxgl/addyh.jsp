...
<div class="am-modal am-modal-no-btn" tabindex="-1" id="modify">
  <div class="am-modal-dialog">
    ...
    <div class="am-modal-bd">
      id=<%=request.getParameter("id")%>
      bs=<%=request.getParameter("bs")%>
      <form class="am-form" action='../cdgl/mod.cs' method='post'>
      <input type="hidden" id='id' name='id' value="<%=request.getParameter("id")%>"/>
     ...
     <table  class="am-table am-table-bordered">
		<tr>
			<td width="10%" align='right'>上级菜单:</td><td width="40%"><input type="text" ng-model='menu.url1' class="" id=""  style='width:400px;float:left;' disabled placeholder="上级菜单名称，不可编辑"></td>

...
<input type="hidden" value="<%=request.getParameter("code")%>" id='code'/> 
<body  ng-controller='controller' style="" >
 <!-- 为ECharts准备一个具备大小（宽高）的Dom window.location.href=<%=basePath%>wait.jsp-->
  <div class="am-g">
      <div id="infor"></div>
      <form action="<%=basePath%>phone/mintuline.jsp" method='post'>
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>股票代码：</b><input type="text"  name='code' ng-model="code" onchange="" value='${code}'> </input>
       <input type="submit"  value='开始推送' ></input>
       </form>
	  <div id="lineChart" class="am-u-sm-12" style="height:750px;"></div>
  </div> 
    <div id="time1"></div>
    <!--[if (gte IE 9)|!(IE)]><!-->
    ...
    <script src="<%=basePath%>phone/js/line.js"></script>  

...
<hr>
 ...
 <div class="am-g" style="height:24px;border:0px red solid;">
		...
		<div class="am-u-sm-2"><a onclick="$('#my-modal-loading').modal();" href="<%=basePath%>ws/morezs.zc?page=1&cmd=first&flag=${flag}">第一页</a> </div>
		<div class="am-u-sm-2"><a onclick="$('#my-modal-loading').modal();" href="<%=basePath%>ws/morezs.zc?page=${page.currentPage}&cmd=pre&flag=${flag}">上一页 </a> </div>		
		<div class="am-u-sm-2"><a onclick="$('#my-modal-loading').modal();" href="<%=basePath%>ws/morezs.zc?page=${page.currentPage}&cmd=next&flag=${flag}">下一页</a> </div>
		<div class="am-u-sm-2 am-u-end "><a href="<%=basePath%>ws/morezs.zc?page=1&cmd=last&flag=${flag}">最后一页</a> </div>
</div>
...
<div class="am-modal am-modal-loading am-modal-no-btn" tabindex="-1"
		...
		<div class="am-modal-dialog">
			...
			<div class="am-modal-bd">
				...
				<img src="<%=basePath%>img/load3.gif"></img> 
			</div>
		</div>
	</div>
</center>

...
<div style="z-index:2;position:absolute;border:0px solid red;left:10px;top:10px;">processid=${id}</div>
<img src="<%=basePath%>jbpm/process.png" style="position:absolute;left:0px;top:0px;" alt=''/>

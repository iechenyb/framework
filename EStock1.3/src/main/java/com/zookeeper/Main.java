...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        // 创建一个与服务器的连接
        ZooKeeper zk = new ZooKeeper("192.168.16.211:2181", 30000, new Watcher() {
            // 监控所有被触发的事件
        ...
        List<String> ktvs = zk.getChildren(ROOT, false);
        System.out.println("读取节点数据："+Arrays.toString(ktvs.toArray()));

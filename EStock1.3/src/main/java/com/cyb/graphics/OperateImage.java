 ...
 public  boolean joinImageListVertical(String[] pics, String type, String dst_pic) {   
  ...
  try {
   ...
   e.printStackTrace();
    ...
    /* String srcPath = "D:/chenyb/pic/t.jpg";
     String toPath = "D:/chenyb/pic/new/t1.jpg";
     int x = 600;
     int y = 600;
     int width = 300;
     int height = 200 ;
...
*/     
     ...
     int x = 200;
     int y = 200;
     String toPath = "D:/chenyb/pic/new/t1t2.jpg";
//        imageObj.mergeBothImage(negativeImagePath, additionImagePath, x, y, toPath); //按指定坐标合并图片
//        imageObj.mergeBothImageTopleftcorner(additionImagePath, negativeImagePath, toPath);//合并到左上角
//        imageObj.mergeBothImageToprightcorner( additionImagePath,negativeImagePath, toPath);//合并到右上角
//        imageObj.mergeBothImageLeftbottom(additionImagePath,negativeImagePath,  toPath);//合并到左下角
//        imageObj.mergeBothImageRightbottom(additionImagePath,negativeImagePath,  toPath);//合并到右下角
//        imageObj.mergeBothImageCenter(additionImagePath,negativeImagePath,  toPath);//合并到正中央
//        imageObj.mergeBothImageTopcenter(additionImagePath,negativeImagePath,  toPath);//合并到上边中央
//        imageObj.mergeBothImageBottomcenter(additionImagePath,negativeImagePath,  toPath);//合并到下边中央
//        imageObj.mergeBothImageLeftcenter(additionImagePath,negativeImagePath,  toPath);//合并到左边中央
//        imageObj.mergeBothImageRightcenter(additionImagePath,negativeImagePath,  toPath);//合并到右边中央
     */
...
//     imageObj.grayImage(srcImage, toPath, imageFormat);//图片灰化
   ...
   */
   ...
   /*  String firstSrcImagePath = "D:/chenyb/pic/t1.jpg";
     String secondSrcImagePath = "D:/chenyb/pic/t2.jpg";
     String imageFormat = "jpg";
     String toPath = "D:/chenyb/pic/new/t1122.jpg";
    ...
    /* String srcImagePath = "D:/chenyb/pic/blank.jpg";
     ...
     int nPoints = 4; 
     String toPath = "D:/chenyb/pic/new/t1111.png";
     imageObj.drawPolygon(srcImagePath, yPoints, xPoints, nPoints, Color.MAGENTA, "png", toPath);*/ //根据坐标数组绘制多边形
    ...
    */ 
     ...
     String toPath = "D:/chenyb/pic/new/polyLine_1.jpg";
     String imageFormat = "jpg";
...
*/          
   ...
   /*  List pointList = new ArrayList();
    ...
    /* String negativeImagePath = "D:/chenyb/pic/t1.jpg";
     ...
     for(int i=0;i<1000;i++){
      ...
      imageObj.mergeBothImage(additionImagePath,negativeImagePath,  x, y, toPath);//每次附加合并一张图片(循环若干次)
      System.out.println(i);
     }
   ...
   /*  List iamgePathList = new ArrayList();  // D:/test/16a/
     ...
     String[] str = (String[]) iamgePathList.toArray(new String[iamgePathList.size()]);    
     imageObj.joinImageListHorizontal(str, imageFormat, toPath);*/

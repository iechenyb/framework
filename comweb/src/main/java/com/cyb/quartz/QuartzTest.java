...
public class QuartzTest {
	...
	public static void quartz() {
		try {
			...
			QuartzManager.addJob(sche, job_name, QuartzJobExample.class,
					"0/1 * * * * ?");
			QuartzManager.addJob(sche, job_name+"1234", QuartzJobExample1.class,
					"0/1 * * * * ?");
			Thread.sleep(3000);
			...
			QuartzManager.removeJob(sche, job_name);
			System.out.println("【移除定时】成功");
			QuartzManager.shutdownJobs(sche);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

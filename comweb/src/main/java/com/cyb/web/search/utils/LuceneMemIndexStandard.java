...
public class LuceneMemIndexStandard {  
	static Log log = LogFactory.getLog(LuceneMemIndexStandard.class);
	public static String DataPath=Contants.WEBPATH+"\\lucene\\example";
	public static String IndexPath=Contants.WEBPATH+"\\lucene\\index1";
	...
	public static void createIndex() throws Exception{  
        ...
        LuceneMemIndexStandard.addDoc(iw);  
        iw.close();  
    }  
    ...
    public static void addDoc(IndexWriter iw)  throws Exception{  
        ...
        for (File file : files) {  
            ...
            String content=LuceneMemIndexStandard.getContent(file);  
	...
	public static int start(String col,String words) throws Exception{
        ...
        return LuceneMemIndexStandard.search(query,words);          
    }

...
//     .openStream()));
   ...
   while ((inputLine = in.readLine()) != null) {
    ...
    double open = Double.parseDouble("34.0");//nextToken() 用于返回下一个匹配的字段
    double high = Double.parseDouble("40.0");
    double low = Double.parseDouble("7");
    double close = Double.parseDouble("23");
    double volume = Double.parseDouble("890");

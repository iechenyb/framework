...
public class RealTimeChart1 extends ChartPanel implements Runnable  
{  
    private static TimeSeries timeSeries;  
    private long value=0;  
      
    public RealTimeChart1(String chartContent,String title,String yaxisName)  
    {  
...
*/        return jfreechart;  
    ...
    RealTimeChart1 rtcp=new RealTimeChart1("Random Data","随机数","数值");  
